...
const ICON_MAP = {
  ...
  "🍩": '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 2.5C6.75 2.5 2.5 6.75 2.5 12S6.75 21.5 12 21.5 21.5 17.25 21.5 12 17.25 2.5 12 2.5Zm0 6a3.5 3.5 0 100 7 3.5 3.5 0 000-7Z"/></svg>',
  "🏖️": '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v18"/><path d="M3.5 12c.9-4.8 4.4-8 8.5-8s7.6 3.2 8.5 8c-2-1.5-3.8-1.5-5.8 0-2-1.5-3-1.5-5 0-2-1.5-3.5-1.5-6.2 0z"/></svg>',
  "🏖": '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v18"/><path d="M3.5 12c.9-4.8 4.4-8 8.5-8s7.6 3.2 8.5 8c-2-1.5-3.8-1.5-5.8 0-2-1.5-3-1.5-5 0-2-1.5-3.5-1.5-6.2 0z"/></svg>',
  "🛏️": '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 18v-6h13a4 4 0 014 4v2"/><path d="M3 15h18"/><path d="M3 12V8"/><path d="M6.5 12v-1.5a1 1 0 011-1H10a1 1 0 011 1V12"/></svg>',
  "🛏": '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 18v-6h13a4 4 0 014 4v2"/><path d="M3 15h18"/><path d="M3 12V8"/><path d="M6.5 12v-1.5a1 1 0 011-1H10a1 1 0 011 1V12"/></svg>',
  "💤": '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 10h6l-6 8h6"/><path d="M13 4h5l-5 6h5"/></svg>',
  ...
  "🗓️": '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/><path d="M8 14h1M12 14h1M16 14h1M8 17.5h1M12 17.5h1"/></svg>',
  "🗓": '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/><path d="M8 14h1M12 14h1M16 14h1M8 17.5h1M12 17.5h1"/></svg>',
